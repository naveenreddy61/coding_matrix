...
def scalar_mul(v, alpha): return Vec(v.D,
...
'''
s = Vec({(i, j) for i in range(5) for j in range(5)},{(0, 0): one, (0, 1): one, (0, 2): one, (0, 3): one, (0, 4): 0, 
...
'''
# s = Vec({(i, j) for i in range(2) for j in range(2)},{(0, 0): one, (0, 1): one, (1,0):0,(1,1):0})
# v = zero_vec({(i, j) for i in range(2) for j in range(2)})
s = Vec({(i, j) for i in range(5) for j in range(5)},{(0, 0): one, (0, 1): one, (0, 2): 0, (0, 3): 0, (0, 4): 0, 
